        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                ...
                <table class="table-auto w-full mt-5">
                    <tr>
                        <th class="border px-4 pt-2">ID</th>
                        <th class="border px-4 pt-2">Todo</th>
                        <th class="border px-4 pt-2">Action</th>
                    </tr>
                    @forelse ($todos as $item)
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <form action="{{ route('todo.destroy', $item->id) }}" method="post" class="inline-block">
                                @csrf
                                @method('delete')
                                <button type="submit">
                                    Delete
